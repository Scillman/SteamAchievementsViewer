...
namespace SteamKit2X2.Internal.SteamAPI
{
    ...
    /// Dota 2 Test
    /// </summary>
    internal sealed class IDOTA2Fantasy_205790 : IDOTA2Fantasy
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        {
            using (dynamic data = WebAPI.GetInterface("IDOTA2Fantasy_205790", API.AppKey))
            {
                KeyValue items = data.GetFantasyPlayerStats(FantasyLeagueID: FantasyLeagueID, l: "english");
            }
        }
        ...
        public void GetFantasyPlayerStats(uint FantasyLeagueID, uint StartTime, uint EndTime, ulong matchid, uint SeriesID, uint PlayerAccountID)
        {
            using (dynamic data = WebAPI.GetInterface("IDOTA2Fantasy_205790", API.AppKey))
            {
                KeyValue items = data.GetFantasyPlayerStats(FantasyLeagueID: FantasyLeagueID, StartTime: StartTime, EndTime: EndTime, matchid: matchid, SeriesID: SeriesID, PlayerAccountID: PlayerAccountID, l: "english");
            }
        }
