...
namespace SteamKit2X2.Internal.SteamAPI
{
    ...
    /// Dota 2
    /// </summary>
    internal sealed class IDOTA2Match_570 : IDOTA2Match
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        {
            using (dynamic data = WebAPI.GetInterface("IDOTA2Match_570", API.AppKey))
            {
        ...
        public void GetTeamInfoByTeamID(ulong start_at_team_id, uint teams_requested)
        {
            using (dynamic data = WebAPI.GetInterface("IDOTA2Match_570", API.AppKey))
            {
                KeyValue items = data.GetTeamInfoByTeamID(start_at_team_id: start_at_team_id, teams_requested: teams_requested, l: "english");
            }
        }
